...
import charm.openstack.cinder_oceanstor as cinder_oceanstor

import charms_openstack.test_utils as test_utils


class TestCinderoceanstorCharm(test_utils.PatchHelper):
    ...
    def _patch_config_and_charm(self, config):
        ...
        c = cinder_oceanstor.CinderoceanstorCharm()
        return c

    def test_cinder_base(self):
        charm = self._patch_config_and_charm({})
        self.assertEqual(charm.name, 'cinder_oceanstor')
